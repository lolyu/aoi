...
# USA
# please refer to following two mails for more details:
# https://lists.ovirt.org/pipermail/users/2016-February/038035.html
# https://lists.ovirt.org/pipermail/users/2012-September/009655.html
...
HOST = "localhost"
PORT = "5432"
con_list = [('dbname', 'engine'), ('user', 'engine'),
			('password' DBPASS), ('host', HOST), ('port', PORT)]


def removeHost(host):

	try:
		con_str = ' '.join(["%s='%s'" % (t[0], t[1]) for t in con_list])
